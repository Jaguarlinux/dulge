...
The dulge code can be fetched using the following command:
...
on gitlab, or the dulge-dev mailing list.  Transient discussion channels
...
The dulge gitlab instance is the primary queue for review and acceptance.
