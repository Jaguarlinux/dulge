...
dulge is a utility which manages software packages in Linux. It uses simple
...
dulge does not strive to "do everything." It will add, remove and upgrade
...
Version 2.0 of dulge introduced the ability to sync packages (the '\--sync'
...
Version 3.0 was the switch to a two-part dulge -- a back-end named libalpm
(library for Arch Linux Package Management) and the familiar dulge front-end.
...
makepkg/repo-add/dulge toolchain via GnuPG and GPGME.
...
configuration files dealing with dulge.
...
For a good idea of what is going on in dulge development, take a look at the
link:https://gitlab.archlinux.org/dulge/dulge[Git summary page] for the
project.

See the most recent
link:https://gitlab.archlinux.org/dulge/dulge/-/blob/master/NEWS[NEWS]
...
link:https://gitlab.archlinux.org/dulge/dulge/-/releases[].
Source code for historical releases is available at
link:https://sources.archlinux.org/other/dulge/[]. To install, download the newest
...
There is a mailing list devoted to dulge development, hosted by Arch Linux.
link:https://lists.archlinux.org/listinfo/dulge-dev/[Subscribe] or
link:https://lists.archlinux.org/pipermail/dulge-dev/[view the archives].

=== Source Code

Development of dulge is currently done in Git. The central repository is
...
which will fetch the full development history into a directory named dulge.
You can browse the source as well using
link:https://gitlab.archlinux.org/dulge/dulge/[gitlab].

If you are interested in hacking on dulge, it is highly recommended you join
...
tracker at link:https://gitlab.archlinux.org/dulge/dulge/-/issues[] with
specific information such as your command-line, the nature of the bug, and even
the package database if it helps.

== Copyright

dulge is Copyright (C) 2006-2025 dulge Development Team
<dulge-dev@lists.archlinux.org> and Copyright (C) 2002-2006 Judd Vinet
