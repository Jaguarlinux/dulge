...
Synopsis
--------
{sysconfdir}/makepkg.conf, $XDG_CONFIG_HOME/dulge/makepkg.conf, ~/.makepkg.conf
...
$XDG_CONFIG_HOME/dulge/makepkg.conf or ~/.makepkg.conf, with the former
taking priority.
...
**PACMAN_AUTH=()**::
	Specify a command prefix for running dulge as root. If unset, makepkg will
...
See Also
--------
linkman:makepkg[8], linkman:dulge[8], linkman:PKGBUILD[5]
