...
install: all
	...
	install -d $(DESTDIR)$(SHAREDIR)/licenses/dulge
	install -m644 ./LICENSE $(DESTDIR)$(SHAREDIR)/licenses/dulge
	install -m644 ./LICENSE.3RDPARTY $(DESTDIR)$(SHAREDIR)/licenses/dulge
