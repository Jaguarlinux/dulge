...
self.description = "dulge-db-upgrade DB version 9 (symlink support removal)"
...
self.cmd = ["dulge-db-upgrade",
        "--root", self.rootdir(),
        "--dbpath", self.dbdir(),
        "--config", self.configfile() ]

self.addrule("PACMAN_RETCODE=0")
self.addrule("FILE_EXIST=var/lib/dulge/local/ALPM_DB_VERSION")
