...
# ALPM
PM_ROOT     = "/"
PM_DBPATH   = "var/lib/dulge"
PM_SYNCDBPATH = "var/lib/dulge/sync"
PM_LOCK     = "var/lib/dulge/db.lck"
PM_CACHEDIR = "var/cache/dulge/pkg"
PM_EXT_PKG  = ".pkg.tar.gz"
PM_HOOKDIR  = "etc/dulge.d/hooks"

# Dulge
PACCONF     = "etc/dulge.conf"
