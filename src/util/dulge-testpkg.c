...
int main(int argc, char *argv[])
{
	...
	if(argc != 2) {
		fprintf(stderr, "dulge-dulge-dulge-testpkg (dulge) v" PACKAGE_VERSION "\n\n");
		fprintf(stderr,	_("Test a dulge package for validity.\n\n"));
		fprintf(stderr,	_("Usage: dulge-dulge-dulge-testpkg <package file>\n"));
		return 1;
	}
