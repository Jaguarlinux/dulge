...
replace_dups_body() {
	...
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" --replaces "A>=0 A>=0" ../pkg_B
	atf_check_equal $? 0
	...
	atf_check_equal $? 0
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd B
	atf_check_equal $? 0
	result=$(dulge-query -C dulge.d -r root -l|wc -l)
	atf_check_equal $result 1
	atf_check_equal $(dulge-query -C dulge.d -r root -p state B) installed
}
...
replace_ntimes_body() {
	...
	atf_check -o ignore -- dulge-create -A noarch -n B-1.0_1 -s "B pkg" ../pkg_B
	atf_check -o ignore -- dulge-create -A noarch -n C-1.0_1 -s "C pkg" ../pkg_C
	atf_check -o ignore -- dulge-create -A noarch -n D-1.0_1 -s "D pkg" ../pkg_D
	atf_check -o ignore -- dulge-rindex -a $PWD/*.dulge
	cd ..

	atf_check -o ignore -e ignore -- \
		dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd A B C D

	cd some_repo
	atf_check -o ignore -- dulge-create -A noarch -n A-1.1_1 -s "A pkg" ../pkg_A
	atf_check -o ignore -- dulge-create -A noarch -n B-1.1_1 -s "B pkg" --replaces "A<1.1" ../pkg_B
	atf_check -o ignore -- dulge-create -A noarch -n C-1.1_1 -s "C pkg" --replaces "A<1.1" ../pkg_C
	atf_check -o ignore -- dulge-create -A noarch -n D-1.1_1 -s "D pkg" --replaces "A<1.1" ../pkg_D
	atf_check -o ignore -e ignore -- dulge-rindex -a $PWD/*.dulge
	cd ..
	...
	atf_check \
		...
		-e ignore \
		-- dulge-install -C dulge.d -r root --repository=$PWD/some_repo -dvyun
}
...
self_replace_body() {
	...
	cd some_repo
	atf_check -o ignore -- dulge-create -A noarch -n A-1.0_1 -s "A pkg" ../pkg_A
	atf_check -o ignore -- dulge-create -A noarch -n B-1.0_1 -s "B pkg" --replaces "A>=0" --provides="A-1.0_1" ../pkg_B
	atf_check -o ignore -- dulge-rindex -a $PWD/*.dulge
	cd ..
	atf_check -o ignore -e ignore -- dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd A
	atf_check -o ignore -e ignore -- dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd B
	atf_check -e ignore \
		-o match:'A-1\.0_1: installed successfully.' \
		-o match:'B-1\.0_1: removed successfully.' \
		-- dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd A
	atf_check -o inline:"A-1.0_1\n" -- dulge-query -C dulge.d -r root -p pkgver A
	atf_check -o inline:"installed\n" -- dulge-query -C dulge.d -r root -p state A
}
...
replace_vpkg_body() {
	...
	cd some_repo
	dulge-create -A noarch -n libGL-32bit-1.0_1 -s "libGL-32bit pkg" ../libGL-32bit
	atf_check_equal $? 0
	dulge-create -A noarch -n catalyst-32bit-1.0_1 -s "catalyst 32bit pkg" \
		--provides "libGL-32bit-1.0_1" --replaces "libGL-32bit>=0" \
		--dependencies "qt-32bit>=0" ../catalyst-32bit
	atf_check_equal $? 0
	dulge-create -A noarch -n qt-32bit-1.0_1 -s "qt 32bit pkg" --dependencies "libGL-32bit>=0" ../qt-32bit
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd libGL-32bit
	atf_check_equal $? 0
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd catalyst-32bit
	atf_check_equal $? 0
}
...
replace_pkg_files_body() {
	...
	cd repo
	dulge-create -A noarch -n libGL-1.0_1 -s "libGL pkg" ../libGL
	atf_check_equal $? 0
	dulge-create -A noarch -n nvidia-1.0_1 -s "nvidia pkg" --provides "libGL-1.0_1" --replaces "libGL>=0" ../nvidia
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/repo -yvd libGL
	atf_check_equal $? 0
	dulge-install -C dulge.d -r root --repository=$PWD/repo -yvd nvidia
	atf_check_equal $? 0
	ls -l root/usr/lib
...
replace_pkg_with_update_body() {
	...
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" --replaces "A>=0" --provides="A-1.1_1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yfd A B
	atf_check_equal $? 0
	result=$(dulge-query -C dulge.d -r root -l|wc -l)
	atf_check_equal $result 1
	atf_check_equal $(dulge-query -C dulge.d -r root -p state B) installed
...
replace_vpkg_with_update_body() {
	...
	echo "B-1.0_1" > pkg_B/usr/bin/foo
	cd some_repo
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" --replaces "awk>=0" --provides="awk-0_1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" --replaces "awk>=0" --provides="awk-0_1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	atf_check_equal $? 0
	cd some_repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --replaces "awk>=0" --provides "awk-0_1" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
...
replace_transitional_pkg_body() {
	...
	atf_check_equal $? 0
	cd some_repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --replaces "B>=0" --provides "B-1.0_1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg - transitional dummy package" --dependencies="A>=0" ../empty
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -ydu
	atf_check_equal $? 0
	result=$(dulge-query -r root -l | wc -l)
	atf_check_equal $result 1
	atf_check_equal $(dulge-query -C dulge.d -r root -p state A) installed
	atf_check_equal $(dulge-query -C dulge.d -r root -p automatic-install A) ""
}
...
replace_transitional_pkg_automatically_installed_body() {
	...
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd --automatic A
	atf_check_equal $? 0
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd B
	atf_check_equal $? 0
	cd some_repo
...
replace_transitional_pkg_automatically_installed2_body() {
	...
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd --automatic A B
	atf_check_equal $? 0
	cd some_repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --replaces "B>=0" --provides "B-1.0_1" ../pkg_A
	atf_check_equal $? 0
	...
	atf_check_equal $result 1
	atf_check_equal $(dulge-query -C dulge.d -r root -p state A) installed
	atf_check_equal $(dulge-query -C dulge.d -r root -p automatic-install A) "yes"
}
...
replace_transitional_pkg_automatically_installed3_body() {
	...
	atf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd --automatic B
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd A
	atf_check_equal $? 0
	cd some_repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --replaces "B>=0" --provides "B-1.0_1" ../pkg_A
...
replace_automatically_installed_dep_body() {
	...
	cd some_repo
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" --dependencies="B>=0 C>=0" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" ../pkg_B
	atf_check_equal $? 0
	...
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --replaces "C>=0" --provides "C-1.0_1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	atf_check_equal $(dulge-query -C dulge.d -r root -p state B) installed
	atf_check_equal $(dulge-query -C dulge.d -r root -p automatic-install A) ""
	atf_check_equal $(dulge-query -C dulge.d -r root -p automatic-install B) "yes"
}
...
replace_automatically_installed_dep3_body() {
	...
	a2tf_check_equal $? 0
	cd ..
	dulge-install -C dulge.d -r root --repository=$PWD/some_repo -yd A C
	atf_check_equal $? 0
	cd some_repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --dependencies="B>=0" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --replaces "C>=0" --provides "C-1.0_1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	...
	atf_check_equal $(dulge-query -C dulge.d -r root -p state B) installed
	atf_check_equal $(dulge-query -C dulge.d -r root -p automatic-install A) ""
	atf_check_equal $(dulge-query -C dulge.d -r root -p automatic-install B) ""
}
