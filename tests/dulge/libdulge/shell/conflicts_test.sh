...
conflicts_trans_body() {
	...
	cd some_repo
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" --conflicts "B>=0" ../pkg_A
	atf_check_equal $? 0
	...
	dulge-install -r root --repository=$PWD/some_repo -dy A B
	# EAGAIN, conflicts.
	atf_check_equal $? 11
	# 0 pkgs installed.
	dulge-query -r root -l|wc -l
	atf_check_equal $(dulge-query -r root -l|wc -l) 0
}
...
conflicts_trans_hold_body() {
	...
	mkdir -p pkg_A/usr/bin pkg_B/usr/bin
	cd some_repo
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" --conflicts "vpkg>19_1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" --provides "vpkg-19_1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	cd some_repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --conflicts "vpkg>19_1" ../pkg_B
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --provides "vpkg-20_1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	dulge-install -r root --repository=$PWD/some_repo -dyuv B
	atf_check_equal $? 11

	echo "B is now on hold"
	dulge-pkgdb -r root -m hold B
	dulge-install -r root --repository=$PWD/some_repo -dyuv
	atf_check_equal $? 0
...
conflicts_trans_vpkg_body() {
	...
	cd some_repo
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" --conflicts "vpkg>=0" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" --provides "vpkg-0_1" ../pkg_B
	atf_check_equal $? 0
	dulge-create -A noarch -n C-1.0_1 -s "C pkg" --dependencies "vpkg>=0" ../pkg_C
	atf_check_equal $? 0
	...
	dulge-install -r root --repository=$PWD/some_repo -dy A C
	# EAGAIN, conflicts.
	atf_check_equal $? 11
	# 0 pkgs installed.
	dulge-query -r root -l|wc -l
...
conflicts_installed_body() {
	...
	dulge-install -r root --repository=$PWD/some_repo -dy A
	atf_check_equal $? 0
	dulge-install -r root --repository=$PWD/some_repo -dy B
	atf_check_equal $? 11
	dulge-query -r root -l|wc -l
	atf_check_equal $(dulge-query -r root -l|wc -l) 1
}
...
conflicts_installed_multi_body() {
	...
	dulge-install -r root --repository=$PWD/some_repo -dy A
	atf_check_equal $? 0
	dulge-install -r root --repository=$PWD/some_repo -dy C
	atf_check_equal $? 11
	dulge-query -r root -l|wc -l
	atf_check_equal $(dulge-query -r root -l|wc -l) 1
}
...
conflicts_trans_update_body() {
	...
	cd repo
	dulge-create -A noarch -n A-1.0_1 -s "A pkg" --provides "xserver-abi-video-19_1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.0_1 -s "B pkg" --conflicts "xserver-abi-video<19" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=$PWD/repo -dy A B
	atf_check_equal $? 0

	cd repo2
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --provides "xserver-abi-video-20_1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --conflicts "xserver-abi-video<20" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=$PWD/repo2 -dyuv
	atf_check_equal $? 0
	atf_check_equal $(dulge-query -r root -p pkgver A) A-1.1_1
	atf_check_equal $(dulge-query -r root -p pkgver B) B-1.1_1

	dulge-install -r root --repository=$PWD/repo -dyvf A B
	atf_check_equal $? 0
	atf_check_equal $(dulge-query -r root -p pkgver A) A-1.0_1
	atf_check_equal $(dulge-query -r root -p pkgver B) B-1.0_1

	dulge-install -r root --repository=$PWD/repo2 -dyvf B-1.1_1
	atf_check_equal $? 11
}
...
conflicts_trans_installed_multi_body() {
	...
	atf_check_equal $? 11
	dulge-query -r root -l|wc -l
	atf_check_equal $(dulge-query -r root -l|wc -l) 2
}
...
conflicts_trans_provrep_body() {
	...
	cd repo
	dulge-create -A noarch -n libGL-19.1_1 -s "libGL" ../libGL
	atf_check_equal $? 0
	dulge-create -A noarch -n libglvnd-1.0_1 -s "libglvnd" --provides "libGL-7.11.1_1" --replaces "libGL>=0" ../libglvnd
	atf_check_equal $? 0
	dulge-create -A noarch -n nvidia-libs-1.0_1 -s "nvidia-libs" --provides "libGL-7.11.1_1" --replaces "libGL>=0" --conflicts "libGL>=7.11" ../nvidia-libs
	atf_check_equal $? 0
	dulge-create -A noarch -n neverball-1.0_1 -s "neverball" --dependencies "libGL>=0" ../neverball
	atf_check_equal $? 0
	...
	dulge-install -r root --repository=$PWD/repo -dy neverball
	atf_check_equal $? 0
	...
	out=$(dulge-query -r root -p pkgver libGL)
	atf_check_equal "$out" "libGL-19.1_1"
	out=$(dulge-query -r root -p pkgver neverball)
	atf_check_equal "$out" "neverball-1.0_1"

	# Now install nvidia-libs
	dulge-install -r root --repository=$PWD/repo -dy nvidia-libs
	atf_check_equal $? 0

	# 2 pkgs installed: nvidia-libs and neverball
	dulge-query -r root -l|wc -l
	atf_check_equal $(dulge-query -r root -l|wc -l) 2
	out=$(dulge-query -r root -p pkgver nvidia-libs)
	atf_check_equal "$out" "nvidia-libs-1.0_1"

	# now create the nvidia-libs pkg with glvnd support
	cd repo
	dulge-create -A noarch -n neverball-1.1_1 -s "neverball" --dependencies "libGL>=0" ../neverball
	atf_check_equal $? 0
	dulge-create -A noarch -n nvidia-libs-1.1_1 -s "nvidia-libs" --dependencies "libglvnd>=0"  ../nvidia-libs
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	# Upgrade nvidia-libs
	dulge-install -r root --repository=$PWD/repo -dyu
	atf_check_equal $? 0

	# 3 pkgs installed: libglvnd, nvidia-libs and neverball
	dulge-query -r root -l|wc -l
	atf_check_equal $(dulge-query -r root -l|wc -l) 3

	out=$(dulge-query -r root -p pkgver libglvnd)
