...
register_one_head() {
	atf_set "descr" "dulge-alternatives: register one pkg with an alternatives group"
}
register_one_body() {
	mkdir -p repo pkg_A/usr/bin
	touch pkg_A/usr/bin/fileA
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileA" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=repo -ydv A
	atf_check_equal $? 0
	rv=1
...
register_one_dangling_head() {
	atf_set "descr" "dulge-alternatives: register one pkg with an alternative dangling symlink"
}
register_one_dangling_body() {
	mkdir -p repo pkg_A/usr/bin
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileA file2:/usr/lib/fileB:/usr/include/fileB" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
...
register_one_relative_head() {
	atf_set "descr" "dulge-alternatives: register one pkg with an alternatives group that has a relative path"
}
register_one_relative_body() {
	mkdir -p repo pkg_A/usr/bin
	touch pkg_A/usr/bin/fileA
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "file:file:/usr/bin/fileA" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
...
register_dups_head() {
	atf_set "descr" "dulge-alternatives: do not register dup alternative groups"
}
register_dups_body() {
	mkdir -p repo pkg_A/usr/bin
	touch pkg_A/usr/bin/fileA
	...
	dulge-install -r root --repository=repo -ydv A
	atf_check_equal $? 0
	dulge-install -r root --repository=repo -ydfv A
	atf_check_equal $? 0
	dulge-install -r root --repository=repo -ydfv A
	atf_check_equal $? 0
	atf_check_equal "$(dulge-alternatives -r root -l|wc -l)" 3
}

atf_test_case register_multi

register_multi_head() {
	atf_set "descr" "dulge-alternatives: register multiple pkgs with an alternatives group"
}
register_multi_body() {
	...
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileA" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileB" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	dulge-install -r root --repository=repo -ydv B
	atf_check_equal $? 0
	rv=1
...
unregister_one_head() {
	atf_set "descr" "dulge-alternatives: unregister one pkg with an alternatives group"
}
unregister_one_body() {
	mkdir -p repo pkg_A/usr/bin
	touch pkg_A/usr/bin/fileA
...
unregister_one_relative_head() {
	atf_set "descr" "dulge-alternatives: unregister one pkg with an alternatives group that has a relative path"
}
...
unregister_multi_head() {
	atf_set "descr" "dulge-alternatives: unregister multiple pkgs with an alternatives group"
}
...
set_pkg_head() {
	atf_set "descr" "dulge-alternatives: set all alternative groups from pkg"
}
set_pkg_body() {
	mkdir -p repo pkg_A/usr/bin pkg_B/usr/bin
	touch pkg_A/usr/bin/A1 pkg_A/usr/bin/A2 pkg_B/usr/bin/B1 pkg_B/usr/bin/B2
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "1:/usr/bin/1:/usr/bin/A1 2:/usr/bin/2:/usr/bin/A2" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --alternatives "1:/usr/bin/1:/usr/bin/B1 2:/usr/bin/2:/usr/bin/B2" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=repo -ydv A B
	atf_check_equal $? 0
	dulge-alternatives -r root -s B
	atf_check_equal $? 0
...
set_pkg_group_head() {
	atf_set "descr" "dulge-alternatives: set one alternative group from pkg"
}
set_pkg_group_body() {
	mkdir -p repo pkg_A/usr/bin pkg_B/usr/bin
	touch pkg_A/usr/bin/A1 pkg_A/usr/bin/A2 pkg_B/usr/bin/B1 pkg_B/usr/bin/B2
	...
	dulge-install -r root --repository=repo -ydv A B
	atf_check_equal $? 0
	dulge-alternatives -r root -s A -g 1
	atf_check_equal $? 0
	dulge-alternatives -r root -s B -g 2
	atf_check_equal $? 0
...
update_pkgs_head() {
	atf_set "descr" "dulge-alternatives: preserve order in updates"
}
update_pkgs_body() {
	mkdir -p repo pkg_A/usr/bin pkg_B/usr/bin
	touch pkg_A/usr/bin/A1 pkg_B/usr/bin/B1
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "1:1:/usr/bin/A1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --alternatives "1:1:/usr/bin/B1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	cd repo
	dulge-create -A noarch -n A-1.2_1 -s "A pkg" --alternatives "1:1:/usr/bin/A1" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.2_1 -s "B pkg" --alternatives "1:1:/usr/bin/B1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
...
less_entries_head() {
	atf_set "descr" "dulge-alternatives: remove symlinks not provided by the new alternative"
}
less_entries_body() {
	mkdir -p repo pkg_A/usr/bin pkg_B/usr/bin
	touch pkg_A/usr/bin/A1 pkg_A/usr/bin/A2 pkg_B/usr/bin/B1
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" --alternatives "1:1:/usr/bin/A1 1:2:/usr/bin/A2" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" --alternatives "1:1:/usr/bin/B1" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
...
less_entries_update_head() {
	atf_set "descr" "dulge-alternatives: remove symlinks not provided by updated packages alternative"
}
...
less_entries_update_body() {
	...
	cd ..
	dulge-install -r root --repository=repo -ydvu
	atf_check_equal $? 0
	rv=1
	[ -e root/usr/bin/2 ] || rv=0
	atf_check_equal $rv 0
...
more_entries_update_head() {
	atf_set "descr" "dulge-alternatives: add symlinks provided by package update"
}
...
more_entries_update_body() {
	...
	atf_check_equal $? 0
	cd repo
	dulge-create -A noarch -n A-1.2_1 -s "A pkg" --alternatives "1:1:/usr/bin/A1 1:2:/usr/bin/A2" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
...
remove_current_provider_head() {
	atf_set "descr" "dulge-alternatives: removing current provider"
}
...
respect_current_provider_head() {
	atf_set "descr" "dulge-alternatives: respecting current provider"
}
respect_current_provider_body() {
	...
	cd repo
	dulge-create -A noarch -n A-1.2_1 -s "A pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileA" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	dulge-install -r root --repository=repo -yud
	atf_check_equal $? 0
...
prune_leftover_groups_head() {
	atf_set "descr" "dulge-alternatives: prune leftover groups on upgrades"
}
prune_leftover_groups_body() {
	...
	cd repo
	dulge-create -A noarch -n C-1.2_1 -s "C pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileC" ../pkg_C
	atf_check_equal $? 0
	dulge-create -A noarch -n A-1.2_1 -s "A pkg" --dependencies "C>=1.2_1" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	dulge-install -r root --repository=repo -ydv B A
	...
	cd repo
	dulge-create -A noarch -n D-1.4_1 -s "D pkg" --alternatives "file:/usr/bin/file:/usr/bin/fileD" ../pkg_D
	atf_check_equal $? 0
	dulge-create -A noarch -n C-1.3_1 -s "C pkg" ../pkg_C
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	dulge-install -r root --repository=repo -ydv C D
	...
	out=$(dulge-query -r root -p pkgver D)
...
replace_alternative_with_symlink_head() {
	atf_set "descr" "dulge-alternatives: replace alternative group with a symlink"
}
replace_alternative_with_symlink_body() {
	...
	cd repo
	dulge-create -A noarch -n A-1.1_2 -s "A pkg" ../pkg_A
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=repo -ydv -Su
	atf_check_equal $? 0
...
keep_provider_on_update_body() {
	...
	cd repo
	dulge-create -n tar-1.0_1 -s tar -A noarch --alternatives 'tar:tar:/usr/bin/gtar' ../tar
	atf_check_equal $? 0
	dulge-create -n bsdtar-1.0_1 -s bsdtar -A noarch --alternatives 'tar:tar:/usr/bin/bsdtar' ../bsdtar
	atf_check_equal $? 0
	dulge-rindex -a *dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repo=repo -y tar bsdtar
	atf_check_equal $? 0
	...
	cd repo/
	dulge-create -n bsdtar-1.0_2 -s bsdtar -A noarch ../bsdtar
	atf_check_equal $? 0
	dulge-rindex -a bsdtar-1.0_2.noarch.dulge
	atf_check_equal $? 0
	cd ..
...
replace_file_with_alternative_body() {
	...
	cd repo
	dulge-create -A noarch -n A-1.1_1 -s "A pkg" ../pkg_A_old
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	cd repo
	dulge-create -A noarch -n B-1.1_1 -s "B pkg" ../pkg_B_old
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	cd repo
	dulge-create -A noarch -n A-1.1_2 -s "A pkg" --alternatives "file:file:/usr/bin/pkg-a-file" ../pkg_A_new
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
	...
	cd repo
	dulge-create -A noarch -n B-1.1_2 -s "B pkg" --alternatives "file:file:/usr/bin/pkg-b-file" ../pkg_B_new
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..
...
cc_alternatives_removal_body() {
	...
	cd repo
	dulge-create -A noarch -n gcc-1.1_1 -s "gcc pkg" --alternatives "cc:cc:/usr/bin/gcc" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n clang-1.1_1 -s "clang pkg" --alternatives "cc:cc:/usr/bin/clang" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=repo -ydv clang gcc
	atf_check_equal $? 0

	ln -s gcc pkg_A/usr/bin/cc
	cd repo
	rm -f *.dulge
	dulge-create -A noarch -n gcc-1.1_2 -s "gcc pkg" ../pkg_A
	atf_check_equal $? 0
	dulge-create -A noarch -n clang-1.1_2 -s "clang pkg" ../pkg_B
	atf_check_equal $? 0
	dulge-rindex -d -a $PWD/*.dulge
	atf_check_equal $? 0
	cd ..

	dulge-install -r root --repository=repo -dvyu gcc clang
	atf_check_equal $? 0
